...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::example::Person* Arena::CreateMaybeMessage<::com::example::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace example {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.example.Person) */ {
 public:
...
inline const std::string& Person::name() const {
  // @@protoc_insertion_point(field_get:com.example.Person.name)
...
void Person::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.example.Person.name)
}
inline std::string* Person::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:com.example.Person.name)
  return _s;
}
...
inline std::string* Person::release_name() {
  // @@protoc_insertion_point(field_release:com.example.Person.name)
...
inline void Person::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.example.Person.name)
}
...
inline int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:com.example.Person.id)
  return _internal_id();
}
...
inline void Person::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:com.example.Person.id)
}
...
inline const std::string& Person::email() const {
  // @@protoc_insertion_point(field_get:com.example.Person.email)
...
void Person::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.email_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.example.Person.email)
}
inline std::string* Person::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:com.example.Person.email)
  return _s;
}
...
inline std::string* Person::release_email() {
  // @@protoc_insertion_point(field_release:com.example.Person.email)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:com.example.Person.email)
}
