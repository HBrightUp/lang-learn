...
public:
    ...
    int Connect(const char* szDbIp, const char* szUser, const char* szPassword,const char* szDBName );
...
public:
    ...
    int m_iFields; //字段个数
    MapFieldNameIndex m_mapFieldNameIndex; //是一个map,  key是字段索引,  value是字段名
    vector<string> m_vcSelectRst;
public:
